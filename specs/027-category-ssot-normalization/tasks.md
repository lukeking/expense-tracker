...
- [x] T025 [US3] Run against the live DB after US1/US2 are merged & deployed: dry-run → review report → `--apply` → save the verification output as `specs/027-category-ssot-normalization/migration-report.md` (FR-010 evidence). Manual; depends on T024 + deployment. Executed 2026-06-11: 15,214 updated, zero drift, idempotence verified — see migration-report.md.
...
Open items: none — **T025 executed 2026-06-11** post-merge/deploy: 15,302 txs · 15,214 updated (15,209 promotions, 15,257 item-tag collapses) · 3 guard-skipped (known D3 pathology, listed) · 124 periods verified, **zero drift** · post-apply dry-run reports zero pending (idempotence). Full evidence in `migration-report.md`. **Feature complete.**
